        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessKeyField = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchedKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StagingRecords_PayloadHash",
                table: "StagingRecords",
                column: "PayloadHash");

            migrationBuilder.CreateIndex(
                name: "IX_StagingRecords_ReceivedAt",
                table: "StagingRecords",
                column: "ReceivedAt");

            migrationBuilder.CreateIndex(
                name: "IX_StagingRecords_Status",
                table: "StagingRecords",
                column: "Status");
        }
